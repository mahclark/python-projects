...
r1,r2 = [[4, 158, 259, 95, 98, 19, 259], [7, 87, 113, 111, 2, 0, 10, 6, 110, 113]]#create_flap(b_flap, True)
#[[5, 22, 148, 207, 36, 69, 146, 148], [3, 22, 176, 134, 20, 176]]
...
while not done:
    ...
    if frameCount >= 300:
        ...
        px1, py1 = ox, oy
        print(gen,org,"max:",int(max_y*100)/100, max_flap)
        frameCount = 0
        score = 0
    ...
    pygame.draw.circle(screen, [0,255,255], (ox,int(oy)), 4)
