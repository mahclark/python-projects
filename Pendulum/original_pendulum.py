...
p2 = DynamicPoint(252, 250)
link1 = Link(center, p1)
link2 = Link(p1, p2)

p3 = DynamicPoint(250, 300, [0,255,0])
p4 = DynamicPoint(248, 250, [0,255,0])
...
##        if abs(distDiff) < 5: #corrections
##        link.p2.x -= (link.p2.x - link.p1.x)*distDiff/link.length
##        link.p2.y -= (link.p2.y - link.p1.y)*distDiff/link.length
