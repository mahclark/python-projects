...
while not done:
    ...
    if g1d == True and curg1 <= 1 and not (curg1 == 1 and already_g1d == False):
        if not g1hs:
            ...
            guard1 = pygame.image.load(dir_path + "/Game Files/Images/Guard/guard_hs{0}.bmp".format(curg1))
    ...
    if g2d == True and curg2 <= 1 and not (curg2 == 1 and already_g2d == False):
        if not g2hs:
            ...
            guard2 = pygame.image.load(dir_path + "/Game Files/Images/Guard/guard_hs{0}.bmp".format(curg2))
